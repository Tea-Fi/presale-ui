...
import { useRevokeApprovalDialog, useConnectedWalletMobile } from "../hooks";
  ...
  return (
    <div className="flex flex-col gap-2 p-2 rounded-xl max-w-[480px] w-[480px] h-auto bg-[rgb(19,19,19)]">
      ...
      >
        <SwapInput
          disabled={
            isFinished || isLoading || selectedTokenPrice == "" || !isReversed
          }
          title=""
          balance={balance}
          value={tokenSellValue}
      ...
      <Button
        ...
        onClick={async () => {
          ...
          if (
            ...
            soonerToast("You need to approve transaction in your wallet", {
              duration: 20000,
              action: {
                label: "Open Wallet",
                onClick: () => open(),
