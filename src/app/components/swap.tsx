      ...
      >
        <SwapInput
          ...
          onType={async (e) => {
            ...
            searchTimeout.current = setTimeout(onCurrencyAmountChange, 500);
          }}
        />
        ...
        <SwapInput
          ...
          onType={async (e) => {
            ...
            clearTimeout(searchTimeout.current);
            searchTimeout.current = setTimeout(onTeaAmountChange, 500);
          }}
        />
      </div>
