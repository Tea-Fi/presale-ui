  ...
  return (
    <Card className="w-64 h-[32-rem]">
      ...
      <div className="flex justify-between text-sm">
        <span className="text-[#f716a2]">You will get</span>
        <span>{formatNumber(parsedTotalAmount)} $TEA</span>
      </div>
      <div className="flex justify-between text-sm mt-2">
        <span className="text-[#f716a2]">Vested</span>
        <span>{formatNumber(parsedTotalVested)} $TEA</span>
      </div>
      <div className="flex justify-between text-sm mt-2 mb-5">
        <span className="text-[#f716a2]">Claimed</span>
        <span>{formatNumber(parsedClaimed)} $TEA</span>
      </div>
