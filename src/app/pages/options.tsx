...
export const Options = () => {
    const [projectInfos, setProjectInfos] = useState<any>(Object.keys(investmentInfo).map(price => ({
        title: `$${price} / $TEA`,
        ...
        const handleOptionsInfo = async () => {
            try {
                ...
                for (let i = 0; i < optionsCount; i++) {
                    ...
                    if (optionsInfo[i].presaleToken == ZeroAddress || investmentInfo[price] == undefined) {
                        continue;
                    }
